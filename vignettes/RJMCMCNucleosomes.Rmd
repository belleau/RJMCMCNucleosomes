...
As with any R package, the **RJMCMCNucleosomes** package should first be loaded with 
...
resultsPostTreatment <- RJMCMCNucleosomes::postTreatment(startPosForwardReads =  
