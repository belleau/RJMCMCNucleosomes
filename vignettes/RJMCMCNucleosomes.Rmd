...
the reads, in a \code{IRanges} format, to create a graph:

```{r visualisation, collapse=TRUE, message=FALSE}
## Extract reads to create an IRange
reads <-IRanges(start = sample$dataIP$start, end=sample$dataIP$end)

## Merge results before post-treatment and after post-treatment in a list
## so that both results will be shown in graph
